...
These instructions will help you to set up your development environment, get the source code of the udacityappmaterial for Android app and build it by yourself. If you want to help developing the app take a look to the [contribution guidelines][0].
...
Open a terminal and type 'android' to start the Android SDK Manager. To build the udacityappmaterial for Android app you will need to install at least the next SDK packages:
...
* Android 8.0 (API 26), SDK Platform; needed to build the udacityappmaterial app.
...
### 1. Fork and download the udacityappmaterial/android repository.

You will need [git][1] to access to the different versions of the udacityappmaterial's source code. The source code is hosted in Github and may be read by anybody without needing a Github account. You will need a Github account if you want to contribute to the development of the app with your own code.

Next steps will assume you have a Github account and that you will get the code from your own fork. 

* In a web browser, go to https://github.com/josefdeutsch/udacityappmaterial, and click the 'Fork' button near the top right corner.
...
* Make official udacityappmaterial repo known as upstream: ```git remote add upstream https://github.com/josefdeutsch/udacityappmaterial.git```
...
[0]: https://github.com/josefdeutsch/udacityappmaterial/blob/master/CONTRIBUTING.md
[1]: https://git-scm.com/
